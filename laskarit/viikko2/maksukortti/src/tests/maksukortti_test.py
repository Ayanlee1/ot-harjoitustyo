...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_ei_vie_negatiiviseksi(self):
        kortti = Maksukortti(200)
        kortti.syo_edullisesti()
        self.assertEqual(kortti.saldo_euroina(), 2.0)
    ...
    def test_voi_ostaa_edullisen_kun_rahaa_tasan_edullisen_verran(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_voi_ostaa_maukkaan_kun_rahaa_tasan_maukkaan_verran(self):
